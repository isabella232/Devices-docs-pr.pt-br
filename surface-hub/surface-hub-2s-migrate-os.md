...
- Windows 10 Pro ou Enterprise do sistema operacional, versão 1909 ou posterior
...
| 7 | [Instale Windows 10 Pro ou Enterprise.](#install-windows-10-pro-or-enterprise)                                        | Use a *unidade BOOTME* para instalar Windows 10 Pro ou Enterprise versão 1909 ou posterior.                                                                                                                                                                                                                                                                                 |
...
1. Baixe o [Surface Hub 2 drivers e o arquivo MSI do Windows Installer](https://www.microsoft.com/download/details.aspx?id=101974). Você usará esse arquivo quando instalar o novo sistema operacional.
...
Você pode instalar uma imagem Windows 10 Pro ou Enterprise (versão *1909* ou posterior) usando uma das seguintes opções:
...
4. Quando a instalação do OOBE (experiência inicial) for iniciada, siga as instruções para instalar Windows 10 Pro ou Enterprise (versão 1909 ou posterior).
