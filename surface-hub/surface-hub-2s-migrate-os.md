---
title: Migrar para Windows 10 ou Windows 11 Pro/Enterprise no Surface Hub 2
...
ms.locfileid: "12448364"
---
# <a name="migrate-to-windows-10-or-windows-11-proenterprise-on-surface-hub-2"></a>Migrar para Windows 10 ou Windows 11 Pro/Enterprise no Surface Hub 2

- [Histórico da versão do artigo](#version-history)

Surface Hub 2S vem com Windows 10 Team instalado. Esta edição personalizada do Windows 10 facilita a colaboração em ambientes de sala de reunião. Agora você pode executar Windows 10 ou Windows 11 Pro/Enterprise para usar seu Surface Hub 2S muito parecido com qualquer outro computador.
...
> [!NOTE]
> Ao instalar o Windows 10 ou Windows 11 Pro/Enterprise em seu Surface Hub 2S, você precisa de uma nova licença distinta da licença de Windows 10 Team existente fornecida com o dispositivo.
...
- Windows 10 ou Windows 11 Pro/Enterprise do sistema operacional, versão 1909 ou posterior
...
| 5 | [Carregue uma unidade flash USB com Windows 10, o pacote SEMM e drivers e firmware.](#load-a-usb-flash-drive-with-a-windows-10-image-semm-package-and-surface-hub-2-drivers-and-firmware) | Crie uma unidade USB que contenha uma Windows 10 imagem. Neste exemplo, a unidade é chamada *BOOTME*. Adicione os drivers e o firmware para o sistema operacional Windows 10 Pro e Enterprise no Surface Hub 2 (da etapa 2) e os arquivos de pacote SEMM (da etapa 4) para a unidade *BOOTME*.                                                                                                                                                                                                  |
...
| 7 | [Instale Windows 10 Pro ou Enterprise.](#install-windows-10-or-windows-11-proenterprise)                                        | Use a *unidade BOOTME* para instalar Windows 10 Pro ou Enterprise versão 1909 ou posterior.                                                                                                                                                                                                                                                                                 |
| 8 | [Instale drivers e firmware para Windows 10 Pro e Enterprise.](#install-surface-hub-2-drivers-and-firmware)                                        | Para garantir que seu dispositivo tenha todas as atualizações e drivers mais recentes, <a href="https://www.microsoft.com/download/details.aspx?id=101974" target="_blank">instale os drivers e o firmware do sistema operacional Windows 10 Pro e Enterprise no arquivo Surface Hub 2 MSI.</a>                                                                                                                                                                                                                                                                                  |
...
1. Na home page Surface Hub 2S, selecione **Iniciar** e abra o aplicativo Surface (**All** **AppsSurface** > ).
...
#### <a name="update-uefi-via-windows-update"></a>Atualizar a UEFI por meio Windows Update
...
1. Acesse **Todos os aplicativos** >  **Configurações** >  **Update e Security** >  **Windows Update** e instale todas as atualizações.
...
1. Na página <a href="https://www.microsoft.com/download/details.aspx?id=46703" target="_blank"> Ferramentas do Surface para IT</a>, selecione **Baixar**.  
...
1. Baixe o [Surface Hub 2 drivers e o arquivo MSI Windows Installer](https://www.microsoft.com/download/details.aspx?id=101974). Você usará esse arquivo quando instalar o novo sistema operacional.
...
1. Selecione **Dispositivos Surface** e selecione **Próximo**.
...
1. Para permitir a instalação de Windows 10 ou Windows 11 Pro/Enterprise, ative **EnableOsMigration** e selecione **Next**.
...
Você pode instalar uma imagem Windows 10 ou Windows 11 Pro/Enterprise (versão *1909* ou posterior) usando uma das seguintes opções:
...
- Uma unidade flash USB que contém uma imagem Windows 10 ou Windows 11 Pro/Enterprise. Essa opção não terá Wi-Fi disponível até após a instalação do OOBE (out-of-box-experience). Depois que a instalação for concluída, instale os drivers e firmware necessários Surface Hub 2 para Windows 10 Pro e [Enterprise](https://www.microsoft.com/download/details.aspx?id=101974) no dispositivo.
...
4. Selecione **Unidade flash USB** e selecione **Next**.
...
6. Copie os arquivos de pacote SEMM e os drivers e firmware do sistema operacional Windows 10 Pro e Enterprise no Surface Hub 2 (o arquivo MSI) para a raiz da unidade flash USB (*BOOTME*) que contém sua imagem Windows 10. A unidade USB BOOTME conterá:
...
1. Para inicializar em UEFI:
   ...
   1. Desativar (desligar) o Surface Hub 2S.
...
### <a name="install-windows-10-or-windows-11-proenterprise"></a>Instalar Windows 10 ou Windows 11 Pro/Enterprise

1. Se sua unidade inicializável Windows 10 ou Windows 11 Pro/Enterprise ainda não estiver na porta USB-A Surface Hub 2, insira-a agora. Em seguida, pressione e solte o botão de energia.
...
4. Quando a instalação do OOBE (experiência inicial) for iniciada, siga as instruções para instalar Windows 10 ou Windows 11 Pro/Enterprise (versão 1909 ou posterior).
...
Para configurar Surface Hub 2S como um dispositivo de produtividade pessoal, consulte [Configure Windows 10 or Windows 11 Pro/Enterprise on Surface Hub 2](surface-hub-2-post-install.md).

> [!NOTE]
>Se você não puder migrar seu dispositivo com êxito para o Windows 10 ou Windows 11 Pro/Enterprise para o Surface Hub 2 seguindo as etapas descritas neste artigo, contate o Surface Hub [Support](https://support.microsoft.com/help/4037644/surface-contact-surface-warranty-and-software-support).
