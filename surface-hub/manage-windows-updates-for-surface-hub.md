...
| --------- | --------- | --------- | --------- | --------- | --------- |
| Avaliação (por exemplo, dispositivos não críticos ou de teste) | Pequeno | Visualização do Windows Insider | Nenhuma.  | Nenhuma.  | Testar e avaliar manualmente a nova funcionalidade. Pausar as atualizações se houver problemas. |
...
Para garantir que o dispositivo esteja sempre disponível para uso durante o horário comercial, o Surface Hub executa suas funções administrativas durante uma janela de manutenção especificada. Durante a janela de manutenção, o Surface Hub instala automaticamente as atualizações por meio do Windows Update ou do WSUS e reinicia o dispositivo se for necessário.
