...
## Atualização de drivers de dispositivo Surface e firmware
...
## Adaptadores Ethernet Surface e implantação do Configuration Manager
...
## Implantar o aplicativo Surface com o Configuration Manager
...
## Usar mídia em pré-teste com clientes Surface
...
## Configurar a redefinição do botão de ação
