...
- **Fatores de formulário flexíveis - como dispositivos** 2 em 1, como o Surface Pro 8, o Surface Go 3 e o Surface Pro X com caneta, toque e teclado desconectada. Você pode até usar [o Surface Duo](/surface-duo/) para se conectar ao AVD.
...
- LTE opções <a href="#3"><sup>3 em dispositivos</sup></a> modernos como Surface Pro X e Surface Go 3 para conectividade segura e sem problemas.
...
- **Unidades removíveis.** Um subconjunto de dispositivos Surface mais recentes apresentam unidades SSD <a href="#6"><sup>removíveis 6</sup></a> fornecendo maior controle sobre a retenção de dados.
...
- Gerenciamento de **firmware** moderno -Usando DFCI (Interface de Configuração de Firmware de Dispositivo),<a href="#7"><sup> 7</sup></a> administradores de IT podem desabilitar remotamente elementos de hardware em um nível de firmware, como microfones, portas USB, slots de cartão SD, câmeras e Bluetooth que remove a energia para o periférico. Windows Defender Credential Guard usa a segurança baseada em virtualização para que somente o software do sistema privilegiado possa acessá-los.
...
<a id="7">7.</a> O DFCI está disponível atualmente para Surface Laptop ES, Surface Laptop Studio, Surface Pro 8, Surface Go 3, Surface Laptop 4, Surface Laptop Go, Surface Book 3, Surface Laptop 3, Surface Pro 7+, Surface Pro 7 e Surface Pro X. . [Saiba mais sobre como](surface-manage-dfci-guide.md) gerenciar as configurações do Surface UEFI.
