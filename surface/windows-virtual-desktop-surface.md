...
- Fatores forma flexíveis, como **dispositivos** de 2 em 1, como Surface Pro 7+, Surface Go 2, Surface Pro 7 e Surface Pro X com caneta, toque e teclado desconectalizável. Você pode até mesmo usar o novo Surface Duo para se conectar ao WVD.
...
Dispositivos Surface 2 em 1, incluindo [Surface Go 2](https://www.microsoft.com/p/surface-go-2) (10.5"), [Surface Pro 7+](https://www.microsoft.com/surface/business/surface-pro-7-plus) (12") e [Surface Pro X](https://www.microsoft.com/p/surface-pro-x/) (13"), fornecem aos usuários o ponto de extremidade de área de trabalho em nuvem ideal que reúne o equilíbrio ideal de portabilidade, versatilidade, energia e bateria de dia inteiro. De engenheiros de site que dependem do Surface Go 2 no modo tablet a consultores financeiros anexando o Surface Pro 7 a um encaixe e vários monitores, os dispositivos 2 em 1 oferecem a versatilidade que chegou a definir o local de trabalho moderno.
 ...
 Ao contrário dos "terminals" de VDI fixos tradicionais, os dispositivos Surface permitem que os usuários trabalhem de qualquer lugar e permitem que as empresas permaneçam viáveis e operacionais durante eventos imprevistos , desde o clima grave até emergências de saúde pública. Com suporte para cenários persistentes, sob demanda e just-in-time, os dispositivos Surface ajudam efetivamente as empresas a sustentar operações contínuas e reduzir o risco de eventos interrupntes. Os recursos projetados para aumentar a produtividade em dispositivos Surface 2 em 1 incluem:

- Telas vibrantes e de alta resolução com taxa de proporção 3:2 para fazer o trabalho.
- Natural inking and multi-touch for more immersive experiences.
- Com uma ampla variedade de recursos de acessibilidade integrados e de terceiros, os dispositivos Surface permitem que você escolha como interagir com seu dispositivo, expressar ideias e fazer o trabalho.
- Microfones de campo distante e alto-falantes de alto desempenho para reuniões virtuais aprimoradas.
- Segurança biométrica, incluindo câmera interna do Windows Hello que vem como padrão em todos os dispositivos Surface.
- Duração de bateria <a href="#2"><sup> longa 2 </sup></a> e carregamento rápido.
- Opções LTE <a href="#3"><sup> 3 em dispositivos modernos, como o Surface Pro X e o Surface Go 2, para conectividade segura e sem </sup></a> problemas.
...
- Segurança de várias camadas de acesso a dados e recursos organizacionais.
- Conformidade com os regulamentos do setor.
- Suporte para uma força de trabalho cada vez mais elástica.
- Necessidades específicas do funcionário em várias funções de trabalho.
...
Para dar suporte à continuidade dos negócios e manter os funcionários produtivos, os dispositivos Surface podem facilmente aumentar a experiência da área de trabalho virtual com acesso offline a arquivos, microsoft 365 e aplicativos de terceiros. Aplicativos tradicionais como o Microsoft Office, disponíveis em .x86, x64, Plataforma Universal do Windows, plataformas ARM, permitem que os usuários se mantenha produtivos no "modo offline". Os arquivos do ambiente de nuvem da área de trabalho virtual também podem ser sincronizados localmente no Surface usando o OneDrive for Business para acesso offline. Você pode ter a confiança de que todas as informações "armazenadas em cache" localmente estão atualizadas e seguras.

Além de adicionar suporte para acesso offline a aplicativos e arquivos, os dispositivos Surface são projetados para otimizar experiências colaborativas como o Microsoft Teams "No Dispositivo". Embora algumas soluções VDI suportem o uso do Teams por meio de uma sessão virtual, os usuários podem se beneficiar da experiência mais otimizada fornecida por uma instância instalada localmente do Teams. A localização de aplicativos de comunicação e colaboração para canais multimídia, como voz, vídeo e legendas ao vivo, permite que as organizações aproveitem ao máximo a capacidade dos dispositivos Surface de fornecer experiências otimizadas do Microsoft 365. A mudança da inteligência artificial (AI) do Surface ou da "IA no dispositivo" dá vida a novos recursos, como a tecnologia de olhar que ajusta a aparência dos seus olhos para que o público veja você olhando diretamente para a câmera ao se comunicar via vídeo.
...
Para resolver esse problema, o Azure oferece a família de série N de Máquinas Virtuais com recursos de GPU NVIDIA (vGPU). Com vGPUs, a EQUIPE de IT pode compartilhar o desempenho da GPU entre várias máquinas virtuais ou cargas de trabalho que exigem energia atribuindo várias GPUs a uma única máquina virtual. Para o Surface, isso significa que, independentemente de qual dispositivo você esteja usando, do Surface Go 2 altamente portátil ao surface laptop 3, seu dispositivo tem acesso ao desempenho gráfico de classe de servidor poderoso.  Surface e vGPUs permitem combinar tudo o que você gosta no Surface, para incluir telas de caneta, toque, teclado, trackpad e PixelSense, com recursos gráficos disponíveis apenas em ambientes de computação de alto desempenho. 
...
- Os dispositivos Surface com Microsoft 365 dão aos usuários até 5 horas em ganhos semanais de produtividade com até 9 horas salvas por semana para funcionários altamente móveis, fornecendo às organizações um ROI de 112% no Microsoft 365 com o Surface
...
Maximizando a eficiência da computação em nuvem, o gerenciamento moderno permite que a EQUIPE melhor atende às necessidades de usuários, participantes e clientes em um ambiente de negócios cada vez mais competitiva. Por exemplo, você pode fazer com que os dispositivos Surface possam ser executados com a interação mínima da sua equipe. A instalação é automática e autoatendada. As atualizações são rápidas e indolors para sua equipe e seus usuários. Você pode gerenciar dispositivos independentemente de sua localização física.
 
Os recursos de segurança e gerenciamento fornecidos com a Área de Trabalho Virtual do Windows no Surface incluem:

- **Windows Update.** Manter o Windows atualizado ajuda você a se manter à frente das novas ameaças de segurança. O Windows 10 foi projetado desde o zero para ser mais seguro e utilizar os recursos de hardware mais recentes para melhorar a segurança. Com uma UEFI 5 e Windows Update para Empresas criadas de propósito que responde a ameaças em evolução, a proteção de ponta a ponta é segura e <a href="#5"><sup> </sup></a> simplificada.

- **Criptografia de hardware.** A criptografia de dispositivo permite que você proteja os dados no Surface para que eles só possam ser acessados por pessoas autorizadas. Todos os dispositivos Surface para Empresas apresentam um DTPM (Trusted Platform Module) discreto, protegido por hardware contra intrusões, enquanto o software usa chaves e medidas protegidas para verificar a validade do software.
- **Windows Defender.** O Windows Defender Antivírus reúne aprendizado de máquina, análise de big data, pesquisa aprofundada de resistência a ameaças e a infraestrutura de nuvem da Microsoft para proteger dispositivos.  A ferramenta é criada e não precisa de agentes extras para ser implantada em dispositivos ou no ambiente VDI, simplificando o gerenciamento e otimizando a configuração inicial do dispositivo. O Windows Defender é integrado e não precisa de agentes extras para ser implantado no dispositivo ou no ambiente VDI, simplificando o gerenciamento e otimizando a configuração do dispositivo. A verdadeira experiência personalizada.
- **Unidades removíveis** - Um subconjunto de dispositivos Surface mais recentes têm unidades SSD removíveis 6, proporcionando maior controle sobre a <a href="#6"><sup> retenção de </sup></a> dados.
- **Autenticação moderna -** O Microsoft 365 e o Surface são uma plataforma unificada que fornece todos os recursos de segurança do Windows (sujeitos a licenciamento e habilitação). Todos os dispositivos de portfólio surface são fornecidas com uma câmera personalizada, projetada para o Windows Hello para Empresas, fornecendo segurança biométrica que persiste perfeitamente de experiências baseadas em VDI no dispositivo.
- Gerenciamento **de firmware** moderno - Usando a DFCI (Interface de Configuração do Firmware de Dispositivo), sete administradores de IT podem desabilitar remotamente elementos de hardware em um nível de firmware, como microfones, portas USB, slots de cartão <a href="#7"><sup> SD, câmeras e Bluetooth, o que remove a energia do </sup></a> periférico. O Windows Defender Credential Guard usa segurança baseada em virtualização para que somente o software do sistema privilegiado possa acessá-los.
- **Compatibilidade com versões inversões** e versões atrás - os dispositivos Windows 10 oferecem compatibilidade com versões mais atrasadas em hardware, software e serviços. A Microsoft tem um histórico forte de manutenção do suporte herdado de hardware, periféricos, software e serviços, incorporando as tecnologias mais recentes. As empresas podem planejar investimentos em IT para ter uma vida útil longa.
...
- [Um guia para o conteúdo técnico e as soluções do Surface](https://boards.microsoft.com/public/prism/104362/category/90968?token=09e688ec4a)
- [Segurança de confiança zero da Microsoft](https://www.microsoft.com/security/business/zero-trust)


----------

<a id="1">1. A Área de Trabalho Virtual do Windows no Surface refere-se à execução da Infraestrutura de Área de Trabalho Virtual do Azure em um dispositivo Surface e é descrita aqui como uma solução de arquitetura, não um produto disponível </a> separadamente.<br>
<a id="2">2. </a> A duração da bateria varia significativamente com configurações, uso e outros fatores.<br>
<a id="3">3. Disponibilidade </a> do serviço e desempenho sujeitos à rede do provedor de serviços. Entre em contato com seu provedor de serviços para obter detalhes, compatibilidade, preços, cartão SIM e ativação. Consulte todas as especificações e frequências em surface.com.<br>
<a id="4">4. Forrester Consulting, "Um estudo de impacto econômico total da Forrester™: maximizando seu ROI do Microsoft 365 Enterprise com o Microsoft Surface", comissionado pela </a> Microsoft, 2018.<br>
<a id="5">5. O Surface Go e o Surface Go 2 usam um UEFI de terceiros e </a> não suportam DFCI. DFCI is currently available for Surface Pro 7+, Surface Laptop Go, Surface Book 3, Surface Laptop 3, Surface Pro 7, and Surface Pro X.<br>
<a id="6">6. O SSD removível está disponível no Surface Laptop 3 e no Surface Pro X. Observe que o disco rígido não é </a> removível pelo usuário. O disco rígido só é removível por um técnico qualificado seguindo as instruções da Microsoft.<br>
<a id="7">7. O DFCI está atualmente disponível para </a> Surface Pro 7+, Surface Laptop Go, Surface Book 3, [](surface-manage-dfci-guide.md) Surface Laptop 3, Surface Pro 7 e Surface Pro X. Saiba mais sobre como gerenciar configurações de UEFI do Surface.
