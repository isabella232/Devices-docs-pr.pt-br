...
##  <a name="surface-book-3-gpus"></a>GPUs do livro de superfície 3
...
###  <a name="intel-iris™-plus-graphics"></a>Elementos gráficos da Intel íris™ Plus
...
###  <a name="nvidia-geforce-gtx-1660-ti"></a>Ti NVIDIA GeForce GTX 1660
...
##  <a name="comparing-gpus-across-surface-book-3"></a>Comparar GPUs entre o catálogo de superfície 3
...
##  <a name="optimizing-power-and-performance-on-surface-book-3"></a>Otimizando o consumo de energia e desempenho no catálogo de superfície 3
...
###  <a name="safe-detach"></a>Desanexação segura
...
###  <a name="modifying-app-settings-to-always-use-a-specific-gpu"></a>Modificando as configurações do aplicativo para sempre usar uma GPU específica
...
##  <a name="appendix-a:-surface-book-3-skus"></a>Apêndice A: SKUs do livro de superfície 3
